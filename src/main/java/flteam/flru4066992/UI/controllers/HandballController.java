...
import flteam.flru4066992.core.conditions.sportspecific.HandballConditions;
...
import static flteam.flru4066992.core.BetType.HANDBALL;
import static java.util.stream.Collectors.toSet;

@Singleton
public class HandballController extends AbstractController {
    ...
    private void setup() {
        Set<String> possibleValues = Arrays.stream(HandballConditions.Type.values()).map(t -> t.value).collect(toSet());
    ...
    private void saveFilter() {
        ...
        context.setFilterComment(HANDBALL, commentArea.getText());
    }
    ...
    public void delete(String tabId, String value) {
        context.removeFilter(HANDBALL, tabId, FootballConditions.Type.find(value));
    }
}
