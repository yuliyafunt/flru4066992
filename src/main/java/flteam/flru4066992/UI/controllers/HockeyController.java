...
import flteam.flru4066992.core.conditions.sportspecific.HockeyConditions;
...
import static flteam.flru4066992.core.BetType.HOCKEY;
import static java.util.stream.Collectors.toSet;

@Singleton
public class HockeyController extends AbstractController {
    ...
    private void setup() {
        Set<String> possibleValues = Arrays.stream(HockeyConditions.Type.values()).map(t -> t.value).collect(toSet());
    ...
    private void saveFilter() {
        ...
        context.setFilterComment(HOCKEY, commentArea.getText());
    }
    ...
    public void delete(String tabId, String value) {
        context.removeFilter(HOCKEY, tabId, FootballConditions.Type.find(value));
    }
}
