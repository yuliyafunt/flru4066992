...
import static flteam.flru4066992.core.BetType.TENNIS;
...
public class TennisController extends AbstractController {
    ...
    private void saveFilter() {
        ...
        context.setFilterComment(TENNIS, commentArea.getText());
    }
    ...
    public void delete(String tabId, String value) {
        context.removeFilter(TENNIS, tabId, FootballConditions.Type.find(value));
    }
}
