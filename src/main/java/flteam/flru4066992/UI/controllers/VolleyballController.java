...
import flteam.flru4066992.core.conditions.sportspecific.VolleyballConditions;
...
import static flteam.flru4066992.core.BetType.VOLLEYBALL;
import static java.util.stream.Collectors.toSet;

@Singleton
public class VolleyballController extends AbstractController {
    ...
    private void setup() {
        Set<String> possibleValues = Arrays.stream(VolleyballConditions.Type.values()).map(t -> t.value).collect(toSet());
    ...
    private void saveFilter() {
        ...
        context.setFilterComment(VOLLEYBALL, commentArea.getText());
    }
    ...
    public void delete(String tabId, String value) {
        context.removeFilter(VOLLEYBALL, tabId, FootballConditions.Type.find(value));
    }
}
